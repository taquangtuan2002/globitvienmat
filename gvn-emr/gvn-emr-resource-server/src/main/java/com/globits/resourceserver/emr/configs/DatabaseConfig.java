package com.globits.resourceserver.emr.configs;
...
@ComponentScan(basePackages = {
		...
		// Security
		"com.globits.security.domain", "com.globits.security.service.impl", "com.globits.security.service",
		//Emr
		"com.globits.emr.domain", "com.globits.emr.service", "com.globits.emr.service.impl"})
@EnableJpaRepositories(basePackages = {
		"com.globits.emr.repository",
		"com.globits.core.repository",
...
//	@Value("classpath:concept_type.sql")
//	private Resource conceptType;
...
//		populator.addScript(conceptType);
		return populator;
	}
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		factory.setPackagesToScan("com.globits.emr.domain",
				"com.globits.core.domain",
