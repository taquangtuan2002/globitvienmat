                ...
                <Grid item lg={10} md={10} sm={10} xs={12} container spacing={2}>
                  ...
                  <Grid item lg={6} md={6} sm={6} xs={12}>
                    <div className="pl-36 pt-36 pr-36 h-100">
                      <div className="mb-16">
                        <h4 className="text-center">{t('signUp.infoLogin')}</h4>
                      </div>
                      <FormControl variant="outlined" fullWidth={true} error={hasErrorEQARound} className="mb-16 w-100">
                        <InputLabel htmlFor="eQARound-simple">{t('signUp.eqaRound')}</InputLabel>
                        <Select
                  ...
                  <Grid item lg={6} md={6} sm={6} xs={12}>
                    <div className="pl-36 pt-36 pr-36 h-100">
                      <div className="mb-16">
                        <h4 className="text-center">{t('signUp.info_eqa_health_org')}</h4>
                      </div>
