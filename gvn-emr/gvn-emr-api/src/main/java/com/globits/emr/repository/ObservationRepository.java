...
public interface ObservationRepository extends JpaRepository<Observation, UUID> {
    ...
    @Query("Select new com.globits.emr.dto.ObservationDto(entity) From Observation entity Where entity.encounter.id = ?1")
    List<ObservationDto> getAllByEncounterId(UUID encounterId);
}
