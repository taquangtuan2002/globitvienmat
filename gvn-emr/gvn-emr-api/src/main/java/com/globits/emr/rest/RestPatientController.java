...
public class RestPatientController {
    ...
    public ResponseEntity<PatientDto> create(@RequestBody PatientDto dto) {
    	Patient result = patientService.saveOrUpdate(null, dto);
    ...
    public ResponseEntity<PatientDto> createEntity(@RequestBody Patient entity) {
    	Patient result = patientService.saveEntity(null, entity);
    	PatientDto resultDto=new PatientDto(result);
        return new ResponseEntity<>(resultDto, HttpStatus.OK);
    }
    ...
    public ResponseEntity<PatientDto> updateEntity(@RequestBody Patient dto, @PathVariable UUID id) {
    	Patient result = patientService.saveEntity(id, dto);
    	PatientDto resultDto=new PatientDto(result);
        return new ResponseEntity<>(resultDto, HttpStatus.OK);
    }
    ...
    public ResponseEntity<PatientDto> update(@RequestBody PatientDto dto, @PathVariable UUID id) {
    	Patient result = patientService.saveOrUpdate(id, dto);
    	PatientDto resultDto=new PatientDto(result);
        return new ResponseEntity<>(resultDto, HttpStatus.OK);
    }
